---
name: archify
description: Generate interactive HTML diagrams (architecture, workflow, sequence, data-flow, lifecycle/state) from plain language or Mermaid input. Use to visualize systems/infra/APIs or convert/beautify Mermaid.
---
